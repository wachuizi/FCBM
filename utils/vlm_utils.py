# revised from https://github.com/Trustworthy-ML-Lab/Label-free-CBM/blob/main/utils.py
...
def zero_out_small_weights(layer, threshold=0.0001):
    with torch.no_grad():
        weight_mask = torch.abs(layer.weight) < threshold
        layer.weight[weight_mask] = 0.0